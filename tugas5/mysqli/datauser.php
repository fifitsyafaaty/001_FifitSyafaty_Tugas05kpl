...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar" style="background-color: #E0F4FF;">
				<a class="sidebar-brand" href="#">
          <span class="align-middle" style="color: black;">Tugas 5 PHP MYSQLI</span>
        </a>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item active" style="background-color: #39A7FF;">
						<a class="sidebar-link" href="datauser.php">
							<i class="align-middle" data-feather="book" style="color: black;"></i> <span class="align-middle">Data User</span>
						</a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="logout.php" style="background-color: #E0F4FF; color: black;">
							<i class="align-middle" data-feather="log-out" style="color: black;"></i> <span class="align-middle">Logout</span>
						</a>
					</li>
			</div>
		</nav>
